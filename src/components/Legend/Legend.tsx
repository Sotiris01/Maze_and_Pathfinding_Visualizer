...
const legendItems: LegendItem[] = [
  ...
  { label: 'Visited (A1)', gradient: 'linear-gradient(135deg, #00bcd4 0%, #9c27b0 100%)' },
  { label: 'Visited (A2)', gradient: 'linear-gradient(135deg, #ff9800 0%, #f44336 100%)' },
...
const Legend: React.FC<LegendProps> = ({ 
  ...
  return (
    <div 
      className={`${styles.legend} ${styles[orientation]} ${compact ? styles.compact : ''}`}
      role="region"
